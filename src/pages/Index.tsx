        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          <div className="animate-fade-in">
            <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-6 leading-tight">
              Get Your Custom <span className="gradient-hero bg-clip-text text-transparent">Automation Strategy</span> Report
            </h1>
          ...
          <div className="animate-scale-in">
            <Button
              ...
              className="gradient-hero hover:opacity-90 text-lg px-12 py-4 rounded-full shadow-medium transition-all hover:shadow-strong hover:scale-105"
            >
